...
public baseUrl:string='http://13.233.217.250:5000/insurex/v1/';
  ...
  "C.P.K.",
  "IMMUNOGLOUBLIN lgG, SERUM",
  "IMMUNOGLOUBLIN lgM, SERUM",
  "IMMUNOGLOUBLIN lgE, SERUM",
  "IMMUNOGLOUBLIN lgA, SERUM",
  "IRON STUDIES, SERUM",
  "IRON",
  ...
  "PARATHYROID HORMONE LEVEL , SERUM",
  "INSULIN LEVEL ( FASTING ) PLASMA ",
  "INSULIN LEVEL ( POSTPRANDOIAL ) PLASMA",
